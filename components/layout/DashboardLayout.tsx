...
export const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const menuItems = [
    { label: 'Dashboard', path: '/member/dashboard', icon: <LayoutDashboard size={20} /> },
    { label: 'Book Transfer', path: '/book', icon: <PlusCircle size={20} /> },
    { label: 'Booking History', path: '/member/bookings', icon: <History size={20} /> },
    { label: 'Profile', path: '/member/profile', icon: <User size={20} /> },
    { label: 'Payment Methods', path: '/member/payment-methods', icon: <CreditCard size={20} /> },
    { label: 'Billing & Invoices', path: '/member/billing', icon: <FileText size={20} /> },
    { label: 'Corporate', path: '/member/corporate', icon: <Briefcase size={20} /> },
    { label: 'Accessibility', path: '/member/accessibility', icon: <Accessibility size={20} /> },
    { label: 'Preferences', path: '/member/preferences', icon: <Settings size={20} /> },
    { label: 'Support', path: '/member/support', icon: <HelpCircle size={20} /> },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row relative">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-white/10 backdrop-blur-lg border-b border-white/20 sticky top-0 z-40">
        <Link to="/" className="font-serif font-bold text-xl text-lux-dark">LuxRide</Link>
          ...
          <div className="pt-6 border-t border-lux-darkSec/10 mt-6 space-y-4">
             ...
             <div className="flex items-center gap-3 px-2">
                 ...
                 <div className="flex-1 min-w-0">
                     <p className="text-sm font-bold text-lux-dark truncate">James Sterling</p>
                     <p className="text-xs text-lux-darkSec truncate">Executive Member</p>
                 </div>
             </div>
