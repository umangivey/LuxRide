...
import { Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle, Car } from 'lucide-react';
    ...
    <div className="min-h-screen pt-28 pb-20 px-4 flex items-center justify-center">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-full bg-lux-gold/10 flex items-center justify-center mx-auto mb-4 text-lux-gold border border-lux-gold/20">
             <Car size={32} />
          </div>
          <h1 className="text-4xl font-serif font-bold text-lux-dark mb-2">Driver Portal</h1>
          <p className="text-lux-darkSec">Sign in to manage your trips and earnings.</p>
        </div>

        <GlassCard className="p-8 md:p-10 border-t-4 border-t-lux-gold">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="driver@luxride.com"
                />
              </div>
            </div>
            ...
            <div className="text-center pt-2">
              <p className="text-sm text-lux-darkSec">
                ...
                <Link to="/driver/signup" className="text-lux-gold font-bold hover:underline">
                  Become a Driver
                </Link>
              </p>
            </div>
